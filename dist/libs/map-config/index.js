...
const { toString: Ge } = Object.prototype, { getPrototypeOf: ce } = Object, W = /* @__PURE__ */ ((e) => (t) => {
  const n = Ge.call(t);
  return e[n] || (e[n] = n.slice(8, -1).toLowerCase());
})(/* @__PURE__ */ Object.create(null)), C = (e) => (e = e.toLowerCase(), (t) => W(t) === e), K = (e) => (t) => typeof t === e, { isArray: D } = Array, q = K("undefined");
function Qe(e) {
...
const Ye = K("string"), x = K("function"), Ce = K("number"), X = (e) => e !== null && typeof e == "object", et = (e) => e === !0 || e === !1, z = (e) => {
  if (W(e) !== "object")
    return !1;
  const t = ce(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(Symbol.toStringTag in e) && !(Symbol.iterator in e);
}, tt = C("Date"), nt = C("File"), rt = C("Blob"), st = C("FileList"), ot = (e) => X(e) && x(e.pipe), it = (e) => {
  let t;
  return e && (typeof FormData == "function" && e instanceof FormData || x(e.append) && ((t = W(e)) === "formdata" || // detect form-data instance
  t === "object" && x(e.toString) && e.toString() === "[object FormData]"));
}, at = C("URLSearchParams"), [ct, lt, ut, ft] = ["ReadableStream", "Request", "Response", "Headers"].map(C), dt = (e) => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const pt = (e, t, n, { allOwnKeys: r } = {}) => (H(t, (s, o) => {
  ...
  for (; t-- > 0; )
    n[t] = e[t];
  return n;
}, Et = /* @__PURE__ */ ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && ce(Uint8Array)), Rt = (e, t) => {
  ...
  for (; (n = e.exec(t)) !== null; )
    r.push(n);
  return r;
}, gt = C("HTMLFormElement"), Ot = (e) => e.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(n, r, s) {
    return r.toUpperCase() + s;
  }
), de = (({ hasOwnProperty: e }) => (t, n) => e.call(t, n))(Object.prototype), Tt = C("RegExp"), Fe = (e, t) => {
...
const Ft = (e) => {
  ...
  return n(e, 0);
}, _t = C("AsyncFunction"), Ut = (e) => e && (X(e) || x(e)) && x(e.then) && x(e.catch), _e = ((e, t) => e ? setImmediate : t ? ((n, r) => (U.addEventListener("message", ({ source: s, data: o }) => {
  ...
  x(U.postMessage)
), Lt = typeof queueMicrotask < "u" ? queueMicrotask.bind(U) : typeof process < "u" && process.nextTick || _e, a = {
  isArray: D,
  isArrayBuffer: xe,
  isBuffer: Qe,
  isFormData: it,
...
function G(e, t, n) {
  ...
  function u(p, y, h) {
    ...
    if (p && !h && typeof p == "object") {
      ...
      else if (a.isArray(p) && Dt(p) || (a.isFileList(p) || a.endsWith(y, "[]")) && (w = a.toArray(p)))
...
}, qt = typeof URLSearchParams < "u" ? URLSearchParams : le, Ht = typeof FormData < "u" ? FormData : null, It = typeof Blob < "u" ? Blob : null, Mt = {
  isBrowser: !0,
  classes: {
    URLSearchParams: qt,
    FormData: Ht,
...
}, we = (e) => (...t) => a.asap(() => e(...t)), on = O.hasStandardBrowserEnv ? /* @__PURE__ */ ((e, t) => (n) => (n = new URL(n, O.origin), e.protocol === n.protocol && e.host === n.host && (t || e.port === n.port)))(
  new URL(O.origin),
  O.navigator && /(msie|trident)/i.test(O.navigator.userAgent)
) : () => !0, an = O.hasStandardBrowserEnv ? (
...
const ze = (e) => {
...
}, Q = typeof fetch == "function" && typeof Request == "function" && typeof Response == "function", $e = Q && typeof ReadableStream == "function", yn = Q && (typeof TextEncoder == "function" ? /* @__PURE__ */ ((e) => (t) => e.encode(t))(new TextEncoder()) : async (e) => new Uint8Array(await new Response(e).arrayBuffer())), Je = (e, ...t) => {
  try {
    return !!e(...t);
  } catch {
    return !1;
  ...
  return e && !t;
}), Se = 64 * 1024, oe = $e && Je(() => a.isReadableStream(new Response("").body)), v = {
  stream: oe && ((e) => e.body)
};
Q && ((e) => {
...
const wn = async (e) => {
  ...
  let R = dn([s, o && o.toAbortSignal()], i), p;
  const y = R && R.unsubscribe && (() => {
    R.unsubscribe();
  });
  let h;
  try {
    if (f && bn && n !== "get" && n !== "head" && (h = await En(u, r)) !== 0) {
      let T = new Request(t, {
        method: "POST",
        body: r,
        duplex: "half"
...
const ge = (e) => `- ${e}`, Sn = (e) => a.isFunction(e) || e === null || e === !1, Ve = {
  getAdapter: (e) => {
    e = a.isArray(e) ? e : [e];
    const { length: t } = e;
    let n, r;
    ...
    for (let o = 0; o < t; o++) {
      n = e[o];
      let i;
      if (r = n, !Sn(n) && (r = ie[(i = String(n)).toLowerCase()], r === void 0))
...
var xn = /* @__PURE__ */ ((e) => (e.MAP_TOKEN = "map-token", e))(xn || {});
const Xe = E.create({
  baseURL: "http://3.87.183.68:8000/api/v1",
  headers: {
...
Xe.interceptors.request.use(
  (e) => {
    ...
    return t && (e.headers.Authorization = `Bearer ${t}`), e.data instanceof FormData ? e.headers["Content-Type"] = "multipart/form-data" : e.headers["Content-Type"] = "application/json", e;
  },
  (e) => (console.error("Request error:", e), Promise.reject(e))
);
Xe.interceptors.response.use(
  (e) => (console.log("Response received:", e), e),
  (e) => (e.response ? (console.error("Response error status:", e.response.status), console.error("Response error data:", e.response.data), e.response.status) : e.request ? console.error("No response received:", e.request) : console.error("Request setup error:", e.message), Promise.reject(e))
);
export {
  xn as LOCAL_STORAGE_KEYS,
  Xe as default,
  Cn as mapConfig
};
